...
"""
o = float(input("Give me a number"))
if o >= 0.9759 and o <= 1.666:
    print ("that is within normal Earth and Mars orbit")
else: 
    print("that is not within normal Earth and Mars orbit")
