...
if USERName == "Guille" or USERName ==  "Blanka" or USERName ==  "Carol" or USERName == "Christine" or USERName == "Richard" or USERName == "Daniel" or USERName == "Chun-Li":
    print(f"Hi {USERName}! You are a VIP!")
else:
